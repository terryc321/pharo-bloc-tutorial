...
** verified that code is straight-through after classInstaller returns , the class is actually viable
...
"Make a method called hello4 in category magic number3 on class ZZFooBar "
(Smalltalk at: #ZZFooBar) compile: 'hello ^ 3' classified: 'magic number3'. 

"Inspect the class"
(Smalltalk at: #ZZFooBar) inspect. 

"create a class side method . message class returns the metaclass of receiver, in this case ZZFooBar class"
